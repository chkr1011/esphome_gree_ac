...
def handle_rx_packet(ser, packet):
    ...
    if (packet[3] == 0x03):
        response = bytearray([0x7E, 0x7E, 0x2F, 0x35, 0x04, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0xE0, 0x00, 0x00, 0x39, 0x39, 0x3E, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x39]);
        ser.write(response)
        log_packet(response, "TX")

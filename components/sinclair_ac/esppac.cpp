...
climate::ClimateTraits SinclairAC::traits()
{
    ...
    traits.set_supported_custom_fan_modes({fan_modes::FAN_AUTO, fan_modes::FAN_LOW, fan_modes::FAN_MED_LOW,
                                           fan_modes::FAN_MED, fan_modes::FAN_MED_HIGH, fan_modes::FAN_HIGH,
